...
const item1 = {name:'item1', price:'400', quantity:'4', discount: '0.3' }
...
const item2 = { name: 'item2', price: '300', quantity: '3', discount: '0.0' }
...
const shoppingBasket = { item1, item2, shopName: 'Sheepmart' }
