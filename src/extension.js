...
Object.assign(book, { pages: 464 })
Object.assign(book, { category: 'Programming' })
// 1. Set this to the book name - using the book object
const name = 'Clean Code'
// book.name = ''
// Object.assign(book, { name: '' })
// 2. Set this to the isbn 10 value - using the book object
const isbn10 = '9780132350884'
Object.assign(book.isbn, { isbn13 })

// book.isbn.isbn10 = ''
// Object.assign(book, { name: 'Clean Code' })
...
Object.assign(basket.items.push(orange))
