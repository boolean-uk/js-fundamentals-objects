...
// 3. category should be Programming - using the book object

book.category = 'Programming'

// 4. pages should be 464 - using the book object

book.pages = 464

// 5. isbn13 should be 978-0132350884 - using the book object and the isbn13 variable above

book.isbn.isbn13 = isbn13

// 6. Remove the dimensions key from the book object
...
// 1. Set the price of the apples to 2

basket.items[0].price = 2

// 2. Add 4 oranges priced at 0.75 to the end of the items list
