...
// Extension: Book should not contain the dimensions key - it should be deleted
delete book.dimensions

// Extension: Book ISBN 13 should be 978-0132350884
book.isbn.isbn13 = isbn13

// Extension: Book should not contain the asin key - it should be deleted
delete book.isbn.asin

// Extension: Book category should be Programming
...
// Extension: The price of apples should be updated to 2
basket.items[0].price = 2

// Extension: 4 oranges priced at 0.75 should be added to the end of the items list
