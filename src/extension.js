...
// 3. Book should not contain the dimensions key - it should be deleted
delete book.dimensions

// 4. Book pages should be 464
book.pages = 464

// 5. Book ISBN 13 should be 978-0132350884
book.isbn.isbn13 = isbn13

// 6. Book category should be Programming
book.category = 'Programming'

// 7. Book should not contain the asin key - it should be deleted
...
// 10. The price of apples should be updated to 2
