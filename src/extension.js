...
// 5. price of apples should be 2
basket.items[0].price = 2;

// 6. book pages should be 464
book.pages = 464;

// 7. 4 oranges priced at 0.75 should be added to the end of items list
basket.items.push({name: 'Oranges', price: 0.75, quantity: 4})

// 8. Book should not contain the asin key - it should be deleted
delete book.isbn.asin

// 9. Book category should be Programming
