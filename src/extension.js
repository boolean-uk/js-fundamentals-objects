...
// 5. Set price of apples to 2
basket.items[0].price = 2

// 6. Add oranges to the basket
basket.items.push({ name: 'Oranges', quantity: 4, price: 0.75 })

// 7. Set book category to programming
book.category = 'Programming'

// 8. Set book pages to 464
book.pages = 464

// 9. Set book.isbn isbn13 to 978-0132350884
book.isbn.isbn13 = '978-0132350884'

// 10. Remove dimensions from book
delete book.dimensions

// 11. Remove asin from book.isbn
