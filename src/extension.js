...
// 5. Change the price of the first item in the basket to 2
basket.items[0].price = 2

// 6. Add 4 oranges to the basket, with a price of 0.75 each
...
// 9. Delete the dimensions key from the book
delete book.dimensions

// 10. Delete the asin key from the book isbn object
delete book.isbn.asin

// 11. Replace the value of the isbn10 variable with the isbn13 value from the book object
