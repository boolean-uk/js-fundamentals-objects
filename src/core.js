...
// 5. Add the following instruments to the person's instruments array: Guitar, Piano, Vocals
...
// 10. Add two objects to the person's friends array with the following properties:
// Friend one: name - Chris, age - 46
// Friend two: name - Dom, age - 43
person.friends.push({ name: 'Chris', age: 46 }, { name: 'Dom', age: 43 })

// 11. Using an index on the person's friends array, set the bestFriend variable below
