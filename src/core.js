...
person.instrument[0]= 'Guitar';
person.instrument[1]= 'Piano';
person.instrument[2]= 'Vocals';
...
person.friends[0].name = 'Chris';
person.friends[0].age = 46;
person.friends[1].name = 'Dom';
person.friends[1].age = 43;
